...
fn main() {
    ...
    let (swapchain, images) = {
        ...
        Swapchain::new(
            ...
            SwapchainCreateInfo {
                ...
                image_usage: ImageUsage {color_attachment:true, ..Default::default()},
    ...
    let vertex_buffer = {
        ...
        let temporary_accessible_buffer = CpuAccessibleBuffer::from_iter(
            &memory_allocator,
            BufferUsage {transfer_src: true, ..Default::default()}, // Specify this buffer will be used as a transfer source.
            false,
            vertices,
        )
        .unwrap();
        ...
        let device_local_buffer = DeviceLocalBuffer::<[Vertex]>::array(
            ...
            BufferUsage {storage_buffer: true, transfer_dst: true, vertex_buffer: true, ..Default::default()}, // Specify use as a storage buffer, vertex buffer, and transfer destination.
